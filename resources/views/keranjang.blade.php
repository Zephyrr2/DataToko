    ...
    <div class="container-fluid">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="{{asset('image/' . $item->foto)}}" alt="{{$item->nama_barang}}" style="width: 30%;"></td>
                    <td>{{ $item->nama_barang }}</td>
                    <td>Rp {{ number_format($item->harga, 0, ',', '.') }}</td>
                    <td>
                        <input type="number" name="qty" value="{{ $item->jumlah }}" class="form-control" onkeyup="updateQty"({{ $item->id_cart }}, this.value)">
                    </td>
